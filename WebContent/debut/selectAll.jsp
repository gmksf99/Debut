...
<!-- page_center영역 -->
  <div id="page_center" height = "200px">
  <div class = "title"><h2 style = "color: #810B0C">상품 전체 보기</h2></div>
    <div id="orderbyList"><form method = "post" action = "selectAll.jsp"><!-- 재귀호출 -->
  ...
  <option value="highPrice">높은가격순</option>
        ...
        <input type="submit" value = " " class = "btn_submit"/></form></div>
    <div class="select">    
     <%
     			String sorting = request.getParameter("sorting");
	  			...
	  			try{//2. try catch문 만듦
	  				...
	  				watches = dao.selectList(conn,sorting);//4. movies에 저장
	  	...
	  	<c:forEach var = "watch" items = "${list }">
	  		<div class="item">
      			<table width="200px" height="300px" cellspacing="0" cellpadding="1">
  					...
  					<tr>
  					  <td class = "watchName">
  					  <a  style="color: #555" href = "/1118/debut/detail.jsp?watchId=${watch.watchId }">
  					  <strong>${watch.watchName }</strong></a></td>
  					</tr>
     			   <tr>
  					  <td class = "price">
  					 <a  style="color: #810B0C" href = "/1118/debut/detail.jsp?watchId=${watch.watchId }"> 
  					  ￦ ${watch.price }</a></td>
  					</tr>
				</table>				
     		 </div>   
