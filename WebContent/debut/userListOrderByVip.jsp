...
<%
    ...
    try{
    	...
    	users = dao.selectListOrderByVip(conn);
    }catch(SQLException e){	}
%>
<c:set var = "list" value = "<%=users %>"/><!-- 스크립트릿에 들어있는 list변수를 el로 꺼내줌/변환/반환 -->

<div id = "page_center" style="height:400px"><!-- page_center -->
<h3 style = "color: #810B0C; margin-top:50px">우수 회원순 정보 조회</h3>
  ...
  <tr>
        <td colspan="8" class = "menu"><p align="right"><a href="userList.jsp" style="color:#000">[전체목록]</a> </p></td>
   </tr>
