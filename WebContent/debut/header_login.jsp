...
<body>
  <div id="page_header">
     <!--logo-->
     <div id="logo">
     <a href="index.jsp"><img src="images/logo.png" width="161" height="52" /></a></div>
     <!-- session -->
     :)  	 <h3 style = "color: #810B0C; display:inline;"><%=session.getAttribute("LOGIN") %></h3>회원님 <a href = "logout.jsp" style="color:#000" >로그아웃</a>
    <!--아이콘-->
    <div class="icons">
      <div class="icon"><a href = "MyPage.jsp"><img src="images/member.png" width="25" height="25" id="Image8" onmouseover="MM_swapImage('Image8','','images/member1.png',1)" onmouseout="MM_swapImgRestore()" /></a></div>
      ...
      <div class="icon"><a href = "cart.jsp"><img src="images/shoppingbag.png" width="25" height="25" id="Image10" onmouseover="MM_swapImage('Image10','','images/shoppingbag1.png',1)" onmouseout="MM_swapImgRestore()" /></a></div>
    </div>
