...
<link href="brandType.css" rel="stylesheet" type="text/css" />
</head>
  ...
  <%
     			...
     			String sorting = request.getParameter("sorting");
	  			...
	  			try{//2. try catch문 만듦
	  				...
	  				watches = dao.sortingList2(conn, sorting, Brand, Type);
	  				//watches = dao.selectBrandType(conn, Brand, Type);
    ...
    <div id="orderbyList"><form method = "post" action = "brandType.jsp?Brand=<%=Brand%>&Type=<%=Type%>"><!-- 재귀호출 -->
    <select name="sorting" class = "orderby">
  <option value="new">신상품순</option>
  <option value="fav">인기상품순</option>
  <option value="lowPrice">낮은가격순</option>
  <option value="highPrice">높은가격순</option>
</select><input type = "submit" value = " " class = "btn_submit"/>
</form></div>
    <div class="select">    
