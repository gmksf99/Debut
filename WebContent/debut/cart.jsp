...
<c:if test="${userId eq null}">
    ...
    <!--page_center영역-->
  <div id="page_center" style = "height:600px">
 	<%
 Integer watchCount=(Integer)session.getAttribute("watchCount");//인티저 타입 객체임
%>   
<c:set var = "watchCount" value ="<%=watchCount %>"/>
<c:if test="${watchCount eq null }">
	<br/><br/><br/><br/><h2>장바구니가 비어있습니다.</h2><br/>
	<a href = "selectAll.jsp" style = "color: #810B0C"><h3>쇼핑하러가기</h3></a>
</c:if>
<c:if test="${watchCount != null }">
