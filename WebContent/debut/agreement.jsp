...
<title>(주)Debut : 약관 동의</title>
<link href="css/join1.css" rel="stylesheet" type="text/css" />
<style type="text/css">
</style>
</head>
<body>
  ...
  <jsp:include page="page_header.jsp" />
    ...
    <div id="container" >
      <!-- content -->
      <div id="content">
        <h2 class="blind">Debut 회원가입 완료</h2>
        <div class="join_content">
          <form name="signlnform" method="post" >
            <!-- 약관동의 -->
            <div class="terms_p">
              <p class="terms_chk_all">
                <span class="input_chk">
                  <input name="chk_all" type="checkbox" class="" id="chk_all" onchange="toggleAllAgreement(this)"> <label id="chk_allLb" for="chk_all">이용약관, 개인정보 수집 및 이용,<br>위치정보 이용약관(선택), 프로모션 안내<br>메일 수신(선택)에 모두 동의합니다.
                  </label>
                </span>
              </p>
              <ul id="termsDiv" class="terms_bx_list" style="display: block">
                <li class="terms_bx terms_service"><span class="input_chk">
                    <input type="checkbox" id="termsService" name="termsService" class="chk required" title="Debut 이용약관 동의" onchange="changeCheckAll()"> <label id="termsServiceLb" for="termsService"> (주)Debut 이용약관 동의<span class="terms_choice">(필수)</span></label>
                  </span>
                  <div class="terms_box">
                    <!-- Début 이용약관 동의 -->
                    <div class="article">
                      <h3 class="article__title">제 1 조 (목적)</h3>
                      <p class="article__text">이 약관은 (주)Debut ("회사" 또는 "(주)Debut")가 제공하는 (주)Debut 및 (주)Debut 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                    </div>
                    <div class="article">
                      <h3 class="article__title">제 2 조 (정의)</h3>
                      <p class="article__text">이 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
                      <ol class="sections">
                        <li class="sections__section">①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 (주)Debut 및 (주)Debut 관련 제반 서비스를 의미합니다.</li>
                    ...
                    <div class="article">
                      ...
                      <ol class="sections">
                        ...
                        <li class="sections__section">③본 조에 따른 세부절차는 "정보통신망법" 및 "저작권법"이 규정한 범위 내에서 "회사"가 정한 "게시중단요청서비스"에 따릅니다.<br> - 게시중단요청서비스 : http://help.naver.com/claim_main.asp
                        </li>
                      </ol>
                    </div>
                    <div class="article">
                  ...
                  <li class="terms_bx terms_privacy"><span class="input_chk">
                    <input type="checkbox" id="termsPrivacy" name="termsPrivacy" class="chk required" title="개인정보 수집 및 이용에 대한 안내" onchange="changeCheckAll()"> <label id="termsPrivacyLb" for="termsPrivacy"> 개인정보 수집 및 이용에 대한 안내<span class="terms_choice">(필수)</span></label>
                </span>
                  <div class="terms_box">
                    <!-- 개인정보 수집 및 이용에 대한 안내 -->
                    <div class="policy_summary">
                      <p class="policy_summary__text">정보통신망법 규정에 따라 (주)Debut에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
                    </div>
                    <div class="article">
                      <h3 class="article__title">1. 수집하는 개인정보</h3>
                      <p class="article__text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 (주)Debut 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 네이버는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
                      <div class="clause">
                        <h4 class="clause__title">회원가입 시점에 (주)Debut가 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
                        <ul class="sections">
                        ...
                        <p class="clause__text">Debut 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p>
                        ...
                        <p class="clause__text"> 구체적으로 1) 서비스 이용 과정에서 이용자에 관한 정보를 정보통신서비스 제공자가 자동화된 방법으로 생성하여 이를 저장(수집)하거나, <br>
                          ...
                          네이버 위치기반서비스 이용 시 수집·저장되는 위치정보의 이용 등에 대한 자세한 사항은 ‘네이버 위치정보 이용약관’에서 규정하고 있습니다. </p>
                      </div>
                    </div>
                    <div class="article">
                    ...
                    <div class="article">
                      ...
                      <div class="clause">
                        ...
                        <p class="clause__text"> 부정가입 및 징계기록 등의 부정이용기록은 부정 가입 및 이용 방지를 위하여 수집 시점으로부터 6개월간 보관하고 파기하고 있습니다. 부정이용기록 내 개인정보는 가입인증 휴대폰 번호(만 14세 미만 회원의 경우 법정대리인 DI)가 있습니다. <br>
                          결제도용, 불법할인대출(일명 '카드깡') 등 관련 법령 및 이용약관을 위반하는 네이버페이의 부정거래기록(아이디, 이름, 휴대폰번호, 배송지 주소, IP주소, 쿠키, 기기정보)은 부정거래 방지 및 다른 선량한 이용자의 보호, 안전한 거래 환경 보장을 위하여 수집 시점으로부터 3년간 보관하고 파기합니다. </p>
                      </div>
                      <div class="clause">
                ...
                <li class="terms_bx terms_location"><span class="input_chk">
                    <input type="checkbox" id="termsLocation" name="termsLocation" value="Y" class="chk" title="위치정보 이용약관 동의" onchange="changeCheckAll()"> <label id="termsLocationLb" for="termsLocation">위치정보 이용약관 동의<span class="terms_choice terms_no">(선택)</span>
                    </label>
                  </span>
                  <div class="terms_box">
                    <!-- 위치정보 이용약관 동의 -->
                    <div class="policy_summary">
                      <p class="policy_summary__text">
                        위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong> 등을 포함하는 Début 위치기반 서비스를 이용할 수 있습니다.
                      </p>
                      <br>
                    </div>
                    <div class="article">
                      <h3 class="article__title">제 1 조 (목적)</h3>
                      <p class="article__text">이 약관은 (주)Debut (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                    </div>
                    <div class="article">
                    ...
                    <div class="article">
                      ...
                      <ol class="sections">
                        ...
                        <li class="sections__section">④개인위치정보주체는 회사에 대하여 아래 자료의 열람 또는 고지를 요구할 수 있고, 당해 자료에 오류가 있는 경우에는 그 정정을 요구할 수 있습니다. 이 경우 회사는 정당한 이유 없이 요구를 거절하지 아니합니다.
                          <ol class="sections">
                        ...
                        <li class="sections__section">⑤회사는 개인위치정보주체가 동의의 전부 또는 일부를 철회한 경우에는 지체 없이 수집된 개인위치정보 및 위치정보 수집ㆍ이용ㆍ제공사실 확인자료를 파기합니다. 단, 동의의 일부를 철회하는 경우에는 철회하는 부분의 개인위치정보 및 위치정보 수집ㆍ이용ㆍ제공사실 확인자료에 한합니다.</li>
                    ...
                    <div class="article">
                      ...
                      <ul class="sections">
                        <li class="sections__section">상호: Début</li>
                        <li class="sections__section">주소: 한국산업기술대학교 (463-867)</li>
                        <li class="sections__section">김나은 김영한 이수빈</li>
                        <li class="sections__section">이메일 주소: KPU123@naver.com</li>
                      </ul>
                    </div>
                    <div class="article">
                ...
                <li class="terms_bx terms_event"><span class="input_chk">
                <input type="checkbox" id="termsEmail" name="termsEmail" value="Y" class="chk" title="이벤트 등 프로모션 알림 메일 수신" onChange="changeCheckAll()">
                <label id="termsEmailLb" for="termsEmail">이벤트 등 프로모션 알림 메일 수신<span class="terms_choice terms_no">(선택)</span></label>
                </span></li>
              </ul>
              <span id="termsMsg" class="error" style="display: none"> Début 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요. </span>
            </div>
            <!-- //약관동의 -->
            <a name="bottom"></a>
            <div class="btn_area double">
              <span>
                ...
                <a href="#" class="btn_type btn_default" onclick="moveNaverMain()">비동의</a>
              </span>
              <span>
                <!-- tg-text=terms_button_red -->
                <a href="#" class="btn_type btn_primary" onclick="validAgreement()">동의</a>
              </span>
            </div>
          </form>
        </div>
...
<script>
	...
	// 비동의 버튼 클릭 함수
	function moveDuMain () {
		if(confirm('Debut 메인 페이지로 이동합니다.')) {
	...
	function validAgreement () {
		...
		// 필수 값 동의 여부 확인
		var terms_list = document.querySelectorAll('.chk'); // 동의 체크박스 모두 가져옴
		var checked_list = [];  // 동의한 모든 check box를 저장하는 변수
		for(var chk_index=0; chk_index < terms_list.length; chk_index++) {
			var term_chk = terms_list[chk_index];

			// 필수 항목 체크
			if(term_chk.hasClass('required')) {
				if(!term_chk.checked) {
					document.getElementById('termsMsg').style.display = 'block';
					return false; // 반복문 멈춤
				} else {
		          document.getElementById('termsMsg').style.display = 'hidden';
		        }
			}

			// 체크 여부 확인
			if(term_chk.checked) {
				checked_list.push(term_chk);
			}
		}

		// 동의한 항목 확인
		var agree_str = '';
		for(var agree_index=0; agree_index < checked_list.length; agree_index++) {
			var agree_chk = checked_list[agree_index];
			agree_str += agree_chk.getAttribute('title') + '에 동의함.' + '\n';
		}
		alert(agree_str);

		// 동의 완료 후 회원가입 폼으로 이동
		location.href = './signInForm.jsp'; // 실제로는 JSP Servlet 경로가 들어감. ex ) localhost:8080/web/jsp/signin.jsp

	};

	// 모두 동의 체크 / 체크해제 함수
	function toggleAllAgreement(chk_all) {
		var terms_list = document.querySelectorAll('.chk'); // 동의 체크박스 모두 가져옴
		var chk_all_checked = chk_all.checked;
		for(var index=0; index < terms_list.length; index++) {
			terms_list[index].checked = chk_all_checked;
		}
	};

	// 각 동의 여부에 따른 모두 동의 체크박스 체크 / 해제 함수
	function changeCheckAll() {
		var terms_list = document.querySelectorAll('.chk'); // 동의 체크박스 모두 가져옴
		var chk_all_checked = true; // 기본값은 모두 동의
		for(var index=0; index < terms_list.length; index++) {
			// 동의하지 않았을 경우, 모두 동의 체크박스 해제
			if(!terms_list[index].checked) {
				chk_all_checked = false;
			}
		}
		// 모두 동의 체크박스에 적용
		document.getElementById('chk_all').checked = chk_all_checked;
	};
